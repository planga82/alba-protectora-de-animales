Ext.application({
    ...
    controllers: ['Principal','Animales','Instituciones', 'Ubicaciones','Personas','Listados','Proveedores'],
    ...
    launch: function() {
		...
		Ext.Ajax.request({
                   ...
                   failure: function(response, action) {
					  ...
					  Ext.Msg.alert('No se ha podido arrancar correctamente la aplicacion', action.result.msg);
                   }
                });
    }
});
