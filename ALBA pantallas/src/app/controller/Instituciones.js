Ext.define('AM.controller.Instituciones', {
	...
	views : [ 'AltaInstitucion', 'ConsultaInstitucion', 'AltaTipoInstitucion',
			'CambioEstadoInstitucion' ],
	...
	PantallaCambioEstadoInstitucion : function(button) {
		...
		view.loadRecord(button.up('consultaInstitucion').query('gridpanel')[0]
	...
	PantallaDetalleInstitucion : function(button) {
		...
		var estado = button.up('consultaInstitucion').query('gridpanel')[0]
	...
	PantallaModificarInstitucion : function(button) {
		...
		view.loadRecord(button.up('consultaInstitucion').query('gridpanel')[0]
				.getSelectionModel().getLastSelected());
		view.title = 'Modificar Instituci�n';
	...
	PantallaGestionUbicacion : function(button) {
		...
		Ext.StoreManager.lookup('Ubicaciones').load(
				{
					params : button.up('consultaInstitucion')
							.query('gridpanel')[0].getSelectionModel()
